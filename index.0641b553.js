...
var _bussinessLogic = require("./BussinessLogic");
function fetchingAndAddingEventListener() {
    document.addEventListener("keydown", function(event) {
        if (0, _bussinessLogic.afterGettingOutput) return;
        let action = event.key;
        if (action === "Enter") {
            (0, _bussinessLogic.spinner)(false);
            (0, _bussinessLogic.checkingAndComparing)();
        } else if (action === "Backspace") (0, _bussinessLogic.backSpace)();
        else if ((0, _bussinessLogic.isLetter)(action)) (0, _bussinessLogic.addLetter)(action.toUpperCase());
    });
}
fetchingAndAddingEventListener();

},{"./BussinessLogic":"1SfLz"}],"1SfLz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "checkingAndComparing", ()=>checkingAndComparing);
parcelHelpers.export(exports, "backSpace", ()=>backSpace);
parcelHelpers.export(exports, "addLetter", ()=>addLetter);
parcelHelpers.export(exports, "spinner", ()=>spinner);
parcelHelpers.export(exports, "isLetter", ()=>isLetter);
parcelHelpers.export(exports, "afterGettingOutput", ()=>afterGettingOutput);
...
async function checkingAndComparing() {
    let obtainedWord = await (0, _apiFetchJs.gettingWord)();
...
},{"./ApiFetch.js":"b9GoP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b9GoP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "gettingWord", ()=>gettingWord);
async function gettingWord() {
...
},{}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequiree659")
